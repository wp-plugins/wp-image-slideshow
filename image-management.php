...
<div class="wrap">
  <?php
    ...
    ?>
  <h2>Wp image slideshow</h2>
  <script language="JavaScript" src="<?php echo get_option('siteurl'); ?>/wp-content/plugins/wp-image-slideshow/setting.js"></script>
      ...
      <tr>
        <td height="35" colspan="2" align="left" valign="bottom"><table width="100%">
            <tr>
			  ...
			  <input name="Help1" lang="publish" class="button-primary" onclick="wpis_help()" value="Help" type="button" />
			  </td>
            </tr>
          </table></td>
      </tr>
