...
function wpis() 
{
	...
	?>
    <script type="text/javascript" src="<?php echo get_option('siteurl') ?>/wp-content/plugins/wp-image-slideshow/wp-image-slideshow.js"></script>
...
function wpis_admin_options() 
{
	...
	echo "<div class='wrap'>";
	echo "<h2>"; 
	echo wp_specialchars( "wp image slideshow" ) ;
	echo "</h2>";
	$wpis_title = get_option('wpis_title');
	$wpis_width = get_option('wpis_width');
	$wpis_height = get_option('wpis_height');
...
function wpis_Show_Filter_Callback($matches) 
{
	...
	//$wpis_pluginurl = get_option('siteurl') . "/wp-content/plugins/wp-image-slideshow/";
	
	$Lr = $Lr .'<script type="text/javascript" src="'.get_option('siteurl').'/wp-content/plugins/wp-image-slideshow/wp-image-slideshow.js"></script>';
...
function wpis_init()
{
	...
	{
		register_sidebar_widget('wp image slideshow', 'wpis_widget');
	}
	
	if(function_exists('register_widget_control')) 
	{
		register_widget_control(array('wp image slideshow', 'widgets'), 'wpis_control');
	} 
}
